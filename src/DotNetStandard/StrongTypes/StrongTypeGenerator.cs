...
#pragma warning restore CS8603 // Possible null reference return.
	...
	/// <summary>
	/// Implements the strong type <see cref="DateTimeStrongType" />.
	/// </summary>
	[GeneratedCode("Herdo.StrongTypes.StrongTypeGenerator", "2.0.0")]
	[Serializable]
	[Newtonsoft.Json.JsonConverter(typeof(DateTimeStrongType.NewtonsoftJsonConverter))]
	[System.Text.Json.Serialization.JsonConverter(typeof(DateTimeStrongType.SystemTextJsonConverter))]
	public partial struct DateTimeStrongType : IEquatable<DateTimeStrongType>, IComparable<DateTimeStrongType>, ISerializable, IXmlSerializable
	{
        /// <summary>
        /// Actual backing property which holds the value.
        /// </summary>
		...
		[ExcludeFromCodeCoverage]
		private DateTimeStrongType(System.DateTime value)
	    {
	        V = value;
	    }

		[ExcludeFromCodeCoverage]
		private DateTimeStrongType(SerializationInfo info, StreamingContext context)
		{
            V = (System.DateTime)info.GetValue("v", typeof(System.DateTime));
		}

	    /// <summary>
	    /// Converts the weak type into a <see cref="DateTimeStrongType"/> instance.
	    /// </summary>
	    /// <param name="value">The value to convert.</param>
	    /// <returns>A new instance of the strong type.</returns>
		[ExcludeFromCodeCoverage]
	    public static explicit operator DateTimeStrongType(System.DateTime value)
	    {
	        return new DateTimeStrongType(value);
	    }

	    /// <summary>
	    /// Converts the strong type into a <see cref="System.DateTime"/> value.
	    /// </summary>
	    /// <param name="value">The instance to convert.</param>
	    /// <returns>The converted value.</returns>
		[ExcludeFromCodeCoverage]
	    public static explicit operator System.DateTime(DateTimeStrongType value)
	    {
	        return value.V;
	    }

		/// <summary>
        /// Returns a value indicating whether this instance and a specified <see cref="DateTimeStrongType"/> object represent the same value.
        /// </summary>
        /// <param name="other">An object to compare to this instance.</param>
        /// <returns><b>true</b> if <paramref name="other"/> is equal to this instance; otherwise, <b>false</b>.</returns>
		[ExcludeFromCodeCoverage]
		public bool Equals(DateTimeStrongType other)
		{
			if (ReferenceEquals(null, other)) return false;
			if (ReferenceEquals(this, other)) return true;
			return this.V == other.V;
		...
		public override bool Equals(object other)
		{
			if (ReferenceEquals(null, other)) return false;
			if (ReferenceEquals(this, other)) return true;
			return Equals((DateTimeStrongType)other);
		}

		/// <summary>
        /// Returns the hash code for this instance.
        /// </summary>
        /// <returns>A hash code for the current <see cref="DateTimeStrongType"/>.</returns>
		[ExcludeFromCodeCoverage]
		public override int GetHashCode()
		{
			if (Equals(null, V))
		...
		/// <summary>
        /// Compares this instance to a specified <see cref="DateTimeStrongType"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">A <see cref="DateTimeStrongType"/> to compare to.</param>
        /// <returns>A signed integer that indicates the relative order of this instance and <paramref name="other"/>.</returns>
		[ExcludeFromCodeCoverage]
		public int CompareTo(DateTimeStrongType other)
		{
			if (Equals(null, V))
				return 1;
			return V.CompareTo(other.V);
        ...
        /// <returns><b>True</b>, if both operands are equal; otherwise, <b>false</b>.</returns>
        [ExcludeFromCodeCoverage]
        public static bool operator ==(DateTimeStrongType first, DateTimeStrongType second)
	    {
	        if (ReferenceEquals(first, second))
	            return true;
        ...
        /// <returns>The difference value.</returns>
        [ExcludeFromCodeCoverage]
        public static System.TimeSpan operator -(DateTimeStrongType minuend, DateTimeStrongType subtrahend)
        {
            return (System.TimeSpan)(minuend.V - subtrahend.V);
        }
...
#pragma warning restore CS8603 // Possible null reference return.
	    ...
	    void IXmlSerializable.ReadXml(XmlReader reader)
	    {
	        V = (System.DateTime)reader.ReadElementContentAs(typeof(System.DateTime), null);
	    }
		
		[ExcludeFromCodeCoverage]
	    void IXmlSerializable.WriteXml(XmlWriter writer)
	    {
            writer.WriteString(XmlConvert.ToString(V, GetSerializationMode(V)));
	    }
		...
		public sealed class NewtonsoftJsonConverter : Newtonsoft.Json.JsonConverter
        {
            ...
            public override void WriteJson(Newtonsoft.Json.JsonWriter writer, object value, Newtonsoft.Json.JsonSerializer serializer)
			{
				var instance = (DateTimeStrongType)value;
				writer.WriteValue(instance.V);
			}
            ...
            public override object ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object existingValue, Newtonsoft.Json.JsonSerializer serializer)
            {
                ...
                var instance = default(DateTimeStrongType);
                instance.V = (System.DateTime) Convert.ChangeType(reader.Value, typeof(System.DateTime));
                return instance;
			}
			
		    [ExcludeFromCodeCoverage]
            public override bool CanConvert(Type objectType) => objectType == typeof(DateTimeStrongType);
        }
        
        public sealed class SystemTextJsonConverter : System.Text.Json.Serialization.JsonConverter<DateTimeStrongType>
        {
		    [ExcludeFromCodeCoverage]
            public override DateTimeStrongType Read(ref System.Text.Json.Utf8JsonReader reader, Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
            {
                return (DateTimeStrongType)reader.GetDateTime();
            }

			[ExcludeFromCodeCoverage]
            public override void Write(System.Text.Json.Utf8JsonWriter writer, DateTimeStrongType value, System.Text.Json.JsonSerializerOptions options)
            {
	...
	/// <summary>
	/// Implements the strong type <see cref="DateTimeOffsetStrongType" />.
	/// </summary>
	[GeneratedCode("Herdo.StrongTypes.StrongTypeGenerator", "2.0.0")]
	[Serializable]
	[Newtonsoft.Json.JsonConverter(typeof(DateTimeOffsetStrongType.NewtonsoftJsonConverter))]
	[System.Text.Json.Serialization.JsonConverter(typeof(DateTimeOffsetStrongType.SystemTextJsonConverter))]
	public partial struct DateTimeOffsetStrongType : IEquatable<DateTimeOffsetStrongType>, IComparable<DateTimeOffsetStrongType>, ISerializable, IXmlSerializable
	{
        /// <summary>
        /// Actual backing property which holds the value.
        /// </summary>
        /// <remarks>This property is basically readonly, but must be non-readonly due to the XML-deserialization which will be called from outside the constructor.</remarks>
        [UsedImplicitly]
		public System.DateTimeOffset V { get; set; }

		[ExcludeFromCodeCoverage]
		private DateTimeOffsetStrongType(System.DateTimeOffset value)
	    {
	        V = value;
	    }

		[ExcludeFromCodeCoverage]
		private DateTimeOffsetStrongType(SerializationInfo info, StreamingContext context)
		{
            V = (System.DateTimeOffset)info.GetValue("v", typeof(System.DateTimeOffset));
		}

	    /// <summary>
	    /// Converts the weak type into a <see cref="DateTimeOffsetStrongType"/> instance.
	    /// </summary>
	    /// <param name="value">The value to convert.</param>
	    /// <returns>A new instance of the strong type.</returns>
		[ExcludeFromCodeCoverage]
	    public static explicit operator DateTimeOffsetStrongType(System.DateTimeOffset value)
	    {
	        return new DateTimeOffsetStrongType(value);
	    }

	    /// <summary>
	    /// Converts the strong type into a <see cref="System.DateTimeOffset"/> value.
	    /// </summary>
	    /// <param name="value">The instance to convert.</param>
	    /// <returns>The converted value.</returns>
		[ExcludeFromCodeCoverage]
	    public static explicit operator System.DateTimeOffset(DateTimeOffsetStrongType value)
	    {
	        return value.V;
	    }

		/// <summary>
        /// Returns a value indicating whether this instance and a specified <see cref="DateTimeOffsetStrongType"/> object represent the same value.
        /// </summary>
        /// <param name="other">An object to compare to this instance.</param>
        /// <returns><b>true</b> if <paramref name="other"/> is equal to this instance; otherwise, <b>false</b>.</returns>
		[ExcludeFromCodeCoverage]
		public bool Equals(DateTimeOffsetStrongType other)
		{
			if (ReferenceEquals(null, other)) return false;
			if (ReferenceEquals(this, other)) return true;
			return this.V == other.V;
		...
		public override bool Equals(object other)
		{
			if (ReferenceEquals(null, other)) return false;
			if (ReferenceEquals(this, other)) return true;
			return Equals((DateTimeOffsetStrongType)other);
		}

		/// <summary>
        /// Returns the hash code for this instance.
        /// </summary>
        /// <returns>A hash code for the current <see cref="DateTimeOffsetStrongType"/>.</returns>
		[ExcludeFromCodeCoverage]
		public override int GetHashCode()
		{
			if (Equals(null, V))
		...
		/// <summary>
        /// Compares this instance to a specified <see cref="DateTimeOffsetStrongType"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="other">A <see cref="DateTimeOffsetStrongType"/> to compare to.</param>
        /// <returns>A signed integer that indicates the relative order of this instance and <paramref name="other"/>.</returns>
		[ExcludeFromCodeCoverage]
		public int CompareTo(DateTimeOffsetStrongType other)
		{
			if (Equals(null, V))
				return 1;
			return V.CompareTo(other.V);
        ...
        /// <returns><b>True</b>, if both operands are equal; otherwise, <b>false</b>.</returns>
        [ExcludeFromCodeCoverage]
        public static bool operator ==(DateTimeOffsetStrongType first, DateTimeOffsetStrongType second)
	    {
	        if (ReferenceEquals(first, second))
	            return true;
        ...
        /// <returns>The difference value.</returns>
        [ExcludeFromCodeCoverage]
        public static System.TimeSpan operator -(DateTimeOffsetStrongType minuend, DateTimeOffsetStrongType subtrahend)
        {
            return (System.TimeSpan)(minuend.V - subtrahend.V);
        }
...
#pragma warning restore CS8603 // Possible null reference return.
	    ...
	    void IXmlSerializable.ReadXml(XmlReader reader)
	    {
	        V = (System.DateTimeOffset)reader.ReadElementContentAs(typeof(System.DateTimeOffset), null);
	    }
		...
		public sealed class NewtonsoftJsonConverter : Newtonsoft.Json.JsonConverter
        {
            ...
            public override void WriteJson(Newtonsoft.Json.JsonWriter writer, object value, Newtonsoft.Json.JsonSerializer serializer)
			{
				var instance = (DateTimeOffsetStrongType)value;
				writer.WriteValue(instance.V);
			}
            ...
            public override object ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object existingValue, Newtonsoft.Json.JsonSerializer serializer)
            {
                ...
                var instance = default(DateTimeOffsetStrongType);
                instance.V = (System.DateTimeOffset) Convert.ChangeType(reader.Value, typeof(System.DateTimeOffset));
                return instance;
			}
			
		    [ExcludeFromCodeCoverage]
            public override bool CanConvert(Type objectType) => objectType == typeof(DateTimeOffsetStrongType);
        }
        
        public sealed class SystemTextJsonConverter : System.Text.Json.Serialization.JsonConverter<DateTimeOffsetStrongType>
        {
		    [ExcludeFromCodeCoverage]
            public override DateTimeOffsetStrongType Read(ref System.Text.Json.Utf8JsonReader reader, Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
            {
                return (DateTimeOffsetStrongType)reader.GetDateTimeOffset();
            }

			[ExcludeFromCodeCoverage]
            public override void Write(System.Text.Json.Utf8JsonWriter writer, DateTimeOffsetStrongType value, System.Text.Json.JsonSerializerOptions options)
            {
				writer.WriteStringValue(value.V);
            }
        }
...
#pragma warning restore CS8603 // Possible null reference return.
		...
		public sealed class NewtonsoftJsonConverter : Newtonsoft.Json.JsonConverter
        {
            ...
            public override object ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object existingValue, Newtonsoft.Json.JsonSerializer serializer)
            {
                ...
                instance.V = (System.Guid) Convert.ChangeType(reader.Value, typeof(System.Guid));
                return instance;
			}
...
#pragma warning restore CS8603 // Possible null reference return.
		...
		public sealed class NewtonsoftJsonConverter : Newtonsoft.Json.JsonConverter
        {
            ...
            public override object ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object existingValue, Newtonsoft.Json.JsonSerializer serializer)
            {
                ...
                instance.V = (System.UInt64) Convert.ChangeType(reader.Value, typeof(System.UInt64));
                return instance;
			}
